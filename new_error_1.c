...
/**
 * _erratoi - a funct that converts a string to an integer
 ...
 * @estr:  a specific string containing specified error type
...
/**
 * convert_number -  a specific converter function, a clone of itoa
 * @num: number
 * @base: base
